...
class MemberController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('frontend.members.edit',compact('member','member_credit','member_debit','member_recovery','banks','member_core'));
    }
    ...
    public function memberCreditUpdate(Request $request)
    {
        ...
        if(count($check_credit_member) > 0)
        {
            ...
            return response()->json(['success' => 'Member credit updated successfully']);
        }else{
            ...
            return response()->json(['success' => 'Member credit added successfully']);
    ...
    public function memberDebitUpdate(Request $request)
    {
        ...
        if(count($check_debit_member) > 0)
        {
            ...
            return response()->json(['success' => 'Member debit updated successfully']);
            ...
            return response()->json(['success' => 'Member debit added successfully']);
        }
    }
    ...
    public function memberRecoveryUpdate(Request $request)
    {
        ...
        return response()->json(['success' => 'Member recovery updated successfully']);
    }
