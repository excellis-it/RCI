...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('member_debits', function (Blueprint $table) {
            ...
            $table->string('hba_cur_instl')->nullable()->after('hba');
            $table->string('hba_total_instl')->nullable()->after('hba_cur_instl');
            $table->string('hba_int_cur_instl')->nullable()->after('hba_int');
            $table->string('hba_int_total_instl')->nullable()->after('hba_int_cur_instl');
            $table->string('car_adv_prin_instl')->nullable()->after('car_adv');
            $table->string('car_adv_total_instl')->nullable()->after('car_adv_prin_instl');
            $table->string('scot_adv_prin_instl')->nullable()->after('sco_adv');
            $table->string('scot_adv_total_instl')->nullable()->after('scot_adv_prin_instl');
            $table->string('sco_adv_int_curr_instl')->nullable()->after('sco_int');
            $table->string('sco_adv_int_total_instl')->nullable()->after('sco_adv_int_curr_instl');
            $table->string('comp_prin_curr_instl')->nullable()->after('comp_adv');
            $table->string('comp_prin_total_instl')->nullable()->after('comp_prin_curr_instl');
            $table->string('comp_adv_int')->nullable()->after('comp_prin_total_instl');
            $table->string('comp_int_curr_instl')->nullable()->after('comp_adv_int');
            $table->string('comp_int_total_instl')->nullable()->after('comp_int_curr_instl');
