    ...
    <div class="container-fluid">
        <div class="breadcome-list">
            <div class="d-flex">
                ...
                <div class="">
                    <h3>Income Tax Slab Listing</h3>
                    <ul class="breadcome-menu mb-0">
                        <li><a href="#">Home</a> <span class="bread-slash">/</span></li>
                        <li><span class="bread-blod">Income Tax Slab Listing</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            @include('frontend.income-tax.form')
                        </div>
                                ...
                                <div class="table-responsive rounded-2">
                                    <table class="table customize-table mb-0 align-middle bg_tbody">
                                        <thead class="text-white fs-4 bg_blue">
                                            <tr>
                                                ...
                                                <th class="sorting" data-sorting_type="desc" data-column_name="lower_slab_amount"
                                                    ...
                                                    style="cursor: pointer"> Higher Slab </th>
                                                <th class="sorting" data-sorting_type="desc" data-column_name="tax_rate"
                                                    style="cursor: pointer">Tax Rate  </th>
                                                <th class="sorting" data-sorting_type="desc" data-column_name="edu_cess_rate"
                                                    style="cursor: pointer">Education CESS Rate </th>
                                        ...
                                        <tbody class="tbody_height_scroll">
                                            @include('frontend.income-tax.table')
                                        </tbody>
                                    </table>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "{{ route('income-taxes.fetch-data') }}",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
    ...
    <script>
        $(document).ready(function() {
            $('#income-tax-create-form').submit(function(e) {
                e.preventDefault();
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#income-tax-edit-form', function(e) {
                e.preventDefault();
