@if (isset($edit))
    <form action="{{ route('leave-type.update', $leaveType->id) }}" method="POST" id="leave-type-edit-form">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-md-8">
...
@else
    <form action="{{ route('leave-type.store') }}" method="POST" id="leave-type-create-form">
        @csrf
        <div class="row">
            <div class="col-md-8">
                <div class="row">
