@if (isset($edit))
    <form action="{{ route('member-income-taxes.update', $memberIncomeTax->id) }}" method="POST"
        id="member-income-tax-edit-form">
        @method('PUT')
        @csrf
                                ...
                                <select class="form-select" name="member_id" id="member_id" disabled>
                                    ...
                                    @foreach ($members as $member)
                                        <option value="{{ $member->id }}"
                                            {{ $member->id == $memberIncomeTax->member_id ? 'selected' : '' }}>
                                            {{ $member->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="description" id="description"
                                    value="{{ $memberIncomeTax->description }}">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="max_deduction" id="max_deduction"
                                    value="{{ $memberIncomeTax->max_deduction }}">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="member_deduction" id="member_deduction"
                                    value="{{ $memberIncomeTax->member_deduction }}">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="year" id="year" disabled>
                                    ...
                                    @foreach ($years as $year)
                                        <option value="{{ $year }}"
                                            {{ $year == $memberIncomeTax->year ? 'selected' : '' }}>
                                            {{ $year }}</option>
                                    @endforeach
                                </select>
                                <span class="text-danger"></span>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="member_deduction"
                                    id="member_deduction">
                                <span class="text-danger"></span>
                            </div>
                        </div>
