            ...
            <div class="row">
                ...
                <div class="form-group col-md-3 mb-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <input type="number" step="any" class="form-control" name="food_day" id="food_day" />
                            <span class="text-danger"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-md-3 mb-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <input type="number" step="any" class="form-control" name="food_amount"
                                id="food_amount" />
                            <span class="text-danger"></span>
                        </div>
                    </div>
                ...
                <div class="form-group col-md-3 mb-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <input type="number" step="any" class="form-control" name="hotel_day" id="hotel_day" />
                            <span class="text-danger"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group col-md-3 mb-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <input type="number" step="any" class="form-control" name="hotel_amount"
                                id="hotel_amount" />
                            <span class="text-danger"></span>
                        </div>
                    </div>
                ...
                <div class="form-group col-md-3 mb-2">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12">
                            <input type="number" step="any" class="form-control" name="total_da" id="total_da" />
                            <span class="text-danger"></span>
                        </div>
                    </div>
                </div>
