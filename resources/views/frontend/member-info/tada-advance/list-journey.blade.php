    ...
    <div class="container-fluid">
        <div class="breadcome-list">
            <div class="d-flex">
                ...
                <div class="">
                    <h3>Detail Journey of @if(isset($member)) {{$member->name}} @endif /@if(isset($tadaAdv)) {{$tadaAdv->bill_no}} @endif</h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        @if($data->count() > 0 )
                        <h4><a href="{{URL::to('/member-info/tada-advance/report-journey/'.$tadaAdv->id)}}"><i class="ti ti-download"></i> Download Report</a></h4>
                        @endif
                        <div id="form">
                            @include('frontend.member-info.tada-advance.form-journey')
                        </div>
                                ...
                                <div class="table-responsive rounded-2">
                                    <table class="table customize-table mb-0 align-middle bg_tbody">
                                        ...
                                        <tbody class="tbody_height_scroll">
                                            @include('frontend.member-info.tada-advance.table-journey')
                                        </tbody>
                                    </table>
