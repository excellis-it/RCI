                                                                ...
                                                                <div class="col-md-8">
                                                                    <select class="form-select" name="pm_index" id="pm_index">
                                                                        ...
                                                                        @foreach($pmIndexes as $pmIndex)
                                                                            <option value="{{ $pmIndex->id }}">{{ $pmIndex->value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <span class="text-danger"></span>
                                                                </div>
                                                                ...
                                                                <div class="col-md-10">
                                                                    <select class="form-select" name="desig" id="desig">
                                                                        ...
                                                                        @foreach($designations as $designation)
                                                                            <option value="{{ $designation->id }}">{{ $designation->designation_type }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <span class="text-danger"></span>
                                                                </div>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select class="form-select" name="division" id="division">
                                                                        ...
                                                                        @foreach($divisions as $division)
                                                                            <option value="{{ $division->id }}">{{ $division->value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <span class="text-danger"></span>
                                                                </div>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <select class="form-select" name="cadre" id="cadre">
                                                                        ...
                                                                        @foreach($cadres as $cadre)
                                                                            <option value="{{ $cadre->id }}">{{ $cadre->value }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    <span class="text-danger"></span>
                                                                </div>
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="form-inline">
                                                                        ...
                                                                        <div class="form-check form-check-inline ml-2">
                                                                            <input class="form-check-input" type="radio" name="pay_stop" id="inlineRadio2" value="full-pay">
                                                                            <label class="form-check-label" for="inlineRadio2">Full Pay</label>
                                                                        </div>
                                                                        <div class="form-check form-check-inline ml-2">
                                                                            <input class="form-check-input" type="radio" name="pay_stop" id="inlineRadio3" value="table-rec">
                                                                            <label class="form-check-label" for="inlineRadio3">Table Rec</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
