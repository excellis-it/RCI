...
<form action="{{ route('members.policy-info.update') }}" id="member-edit-policy-form" method="post">
    ...
    <input type="hidden" name="member_policy_id" value="{{ $member_policy->id }}" >
<div class="row">
    <div class="col-md-3">
                ...
                <div class="col-md-12">
                    <select class="form-select" name="policy_name" id="policy_name">
                        @foreach ($policies as $policy)
                            <option value="{{ $policy->policy_name }}"  {{ isset($member_policy->policy_name) && $policy->policy_name == $member_policy->policy_name ? 'selected' : '' }}>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <select class="form-select" name="policy_no" id="policy_no">
                        @foreach ($policies as $policy)
                            <option value="{{ $policy->policy_no }}"  {{ isset($member_policy->policy_no) && $policy->policy_no == $member_policy->policy_no ? 'selected' : '' }}>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <select class="form-select" name="rec_stop" id="rec_stop">
                        <option value="Yes" {{ $member_policy->rec_stop == 'Yes' ? 'selected':'' }}>Yes</option>
                        <option value="No" {{ $member_policy->rec_stop == 'No' ? 'selected':'' }}>No</option>
                    </select>
                    <span class="text-danger"></span>
                </div>
            </div>
