                ...
                <div class="row">
                                ...
                                <select class="form-select" name="financial_year" id="financial_year">
                                    ...
                                    @foreach ($financialYears as $financialYear)
                                        <option value="{{ $financialYear }}"
                                            {{ $payband->year == $financialYear ? 'selected' : '' }}>{{ $financialYear }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select" name="payband_type_id" id="payband_type_id">
                                    ...
                                    @foreach ($payband_types as $paybandType)
                                        <option value="{{ $paybandType->id }}"
                                            {{ $payband->payband_type_id == $paybandType->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group col-md-5 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" value="{{ $payband->high_band }}"
                                    name="high_band" id="high_band" placeholder="">
                    ...
                    <div class="form-group col-md-7 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" value="{{ $payband->low_band }}"
                                    name="low_band" id="low_band" placeholder="">
                ...
                <div class="row">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <select class="form-select" name="payband_type_id" id="payband_type_id">
                                    <option value="">Select PayBand</option>
                                    @foreach ($payband_types as $paybandType)
                                        <option value="{{ $paybandType->id }}">{{ $paybandType->payband_type }}
                                        </option>
                                    @endforeach
                                </select>
                                <span class="text-danger"></span>
                    ...
                    <div class="form-group col-md-5 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="high_band" id="high_band"
                                    placeholder="">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-7 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="low_band" id="low_band"
                                    placeholder="">
                                <span class="text-danger"></span>
                            </div>
                        </div>
