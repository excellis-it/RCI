            ...
            <div class="d-flex">
                ...
                <div class="">
                    ...
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod">Policy Listing</span></li>
                    </ul>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#policy-edit-form', function(e) {
                e.preventDefault();
