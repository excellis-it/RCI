        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                                <form id="annualfor16Form" >
                                 {{-- <form id="" action="{{ route('reports.form-16b-generate') }}" method="POST"> --}}
                                @csrf
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('annualfor16Form');
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch("{{ route('reports.form-16b-generate') }}", {
                        method: 'POST',
                        headers: {
