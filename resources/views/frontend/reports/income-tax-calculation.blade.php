...
@section('title')
    INCOME TAX CALCULATION Generate
@endsection
    ...
    <div class="container-fluid">
        <div class="breadcome-list">
            <div class="d-flex">
                ...
                <div class="">
                    <h3>INCOME TAX CALCULATION Generate</h3>
                    <ul class="breadcome-menu mb-0">
                        <li><a href="#">Home</a> <span class="bread-slash">/</span></li>
                        <li><span class="bread-blod">INCOME TAX CALCULATION </span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            <form action="{{ route('reports.income-tax-calculation-report-generate') }}" method="POST">
                                @csrf
