            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="
                  ...
                  DATED: {{ \Carbon\Carbon::parse($member_data->doj_service2)->format('d M Y') ?? 'dd Mon Year' }}.
                </td>
              </tr>
              <tr>
                <td style="
              ...
              <tr>
                ...
                <td style="
                      ...
                      text-transform: uppercase;
                    ">
                  DA-{{ $member_credit_data->da ?? '0' }}/- TPT Allow: {{ $member_credit_data->tpt ?? '0' }}/-<br> DA on TPT- {{ $member_credit_data->da_on_tpt ?? '0' }}/- V.I-
                  {{ $member_credit_data->var_incr ?? '0' }}/- HRA {{ $member_credit_data->hra ?? '0' }}/¬
                </td>
              </tr>
              <tr>
                <td style="
            ...
            <tbody>
              <tr>
                <td style="
                      ...
                      padding: 0px 5px !important;
                    ">
                 <span style="margin-right: 15px"> 1)</span> GPF : {{ $member_debit_data->gpa_sub ?? 0 }}/-
                </td>
                <td style="
                      font-size: 10px;
                      line-height: 14px;
                      ...
                      padding: 0px 5px !important;
                    ">
                  <span style="margin-right: 15px">2)</span> CGEGIS : {{ $member_debit_data->cgegis ?? 0 }}/-
                </td>
              </tr>
              <tr>
                <td style="
                      ...
                      padding: 0px 5px !important;
                    ">
                 <span style="margin-right: 15px">3)</span> CGHS : {{ $member_debit_data->cghs ?? 0 }}/-
                </td>
                <td style="
                      font-size: 10px;
                      line-height: 14px;
                      ...
                      padding: 0px 5px !important;
                    ">
                  <span style="margin-right: 15px">4)</span> P.T : {{ $member_debit_data->ptax ?? 0 }}/-
                </td>
              </tr>
              <tr>
                <td style="
                      ...
                      padding: 0px 5px !important;
                    ">
                 <span style="margin-right: 15px">5)</span> I.Tax : {{ $member_debit_data->i_tax ?? 0 }}/-
                </td>
                <td style="
                      font-size: 10px;
                      line-height: 14px;
                      ...
                      padding: 0px 5px !important;
                    ">
                  <span style="margin-right: 15px">6)</span> E.Cess : {{ $member_debit_data->ecess ?? 0 }}/-
                </td>
              </tr>
              <tr>
                <td style="
                      ...
                      padding: 0px 5px !important;
                    ">
                  <span style="margin-right: 15px">7)</span> Welfare: {{ $member_recoveries_data->wel_sub ?? 0 }}/-
                </td>
                <td style="
                      font-size: 10px;
                      line-height: 14px;
            ...
            <tbody>
              ...
              <tr>
                <td style="
                      ...
                      text-transform: uppercase;
                    ">
                  <span style="margin: 0px 20px 0px 40px"> i)</span> Pay & Allowances
              ...
              <tr>
                <td style="
                      ...
                      text-transform: uppercase;
                    ">
                  <span style="margin: 0px 20px 0px 40px"> ii)</span> Professional
              ...
              <tr>
                <td style="
                      ...
                      text-transform: uppercase;
                    ">
                   <span style="margin: 0px 20px 0px 40px"> iii) </span> The Officer has been paid newspaper allowance upto 30/06/2023.
                </td>
              </tr>
              <tr>
                <td style="
                      ...
                      text-transform: uppercase;
                    ">
                 <span style="margin: 0px 20px 0px 40px"> iv) </span> The Officer has
            ...
            <tbody>
              <tr>
                <td style="
                      ...
                      text-decoration: underline;
                    ">
                  Station <span style="margin-right: 15px"></span><span style="margin-right: 15px"></span>:  
                </td>
                <td style="
                      font-size: 10px;
                      line-height: 14px;
              ...
              <tr>
                <td style="
                      ...
                      text-decoration: underline;
                    ">
                  Date<span style="margin-right: 15px"></span><span style="margin-right: 15px"></span>      :
                </td>
                <td style="
                      font-size: 10px;
                      line-height: 14px;
