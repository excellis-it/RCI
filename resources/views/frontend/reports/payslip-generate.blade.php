                            ...
                            <tbody>
                                <tr>
                                    ...
                                    margin: 0px 0px !important;">
                                        ...
                                        उच्च ऊर्जा प्रणाली एबं विज्ञान केंद्र विग्रयान कांचा (डाकघर ), हैदराबाद -
                                        500069<br>
                    ...
                    <td style="padding:0 0px">
                        <table width="100%" border="1" cellpadding="3" cellspacing="0" align="center">
                            <tbody>
                                <tr>
                                    <th colspan="2"
                                        style="font-size: 10px; line-height: 14px; font-weight: 600; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                        जमा / CREDITS</th>
                                    <th colspan="2"
                                        style="font-size: 10px; line-height: 14px; font-weight: 600; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                ...
                                <tr>
                                    <td
                                        style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                        मूल बेतन / BASIC PAY
                                    </td>
                                    <td
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; height: 20px; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                ...
                                <tr>
                                    <td
                                        style="font-size: 10px; line-height: 14px; font-weight: 600; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; height: 20px; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                        कुल / TOTAL
                                    </td>
                                    <td
                    ...
                    <td style="padding:0 0px">
                        <table width="100%" border="0" cellpadding="3" cellspacing="0" align="center">
                            <tbody>
                                <tr>
                                    <td
                                        style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: left;  text-transform: uppercase; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                        Note :
                                    </td>
                                    <td
                    ...
                    <td style="padding:0 0px">
                        <table width="100%" border="1" cellpadding="3" cellspacing="0" align="center">
                            <tbody>
                                <tr>
                                    <td
                                        style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; height: 20px; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    </td>
                                    <td
                                        style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
