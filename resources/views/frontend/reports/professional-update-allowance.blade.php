...
@section('title')
    Professional Update Allowance Report Generate
@endsection
            ...
            <div class="d-flex">
                ...
                <div class="">
                    ...
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod">Professional Update Allowance</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            <form action="{{ route('reports.professional-update-allowance-generate') }}" method="POST" >
                                @csrf
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group col-md-12 mb-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="form-group col-md-9 mb-2" id="pua_group_div" hidden>
                                                            <div class="row">
                                                                <div class="form-group col-md-3 mb-2">
                                                                    <div class="col-md-12">
    ...
    <script>
        $(document).ready(function() {
            $('#type').change(function() {
                var type = $(this).val();
                if(type == 'group') {
                    $('#pua_group_div').prop('hidden', false);
                    $('#pua_ind_div').prop('hidden', true);
                } else {
                    $('#pua_group_div').prop('hidden', true);
                    $('#pua_ind_div').prop('hidden', false);
                }
            });
        });
    </script>
