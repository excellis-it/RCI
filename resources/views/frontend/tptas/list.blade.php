            ...
            <div class="d-flex">
                ...
                <div class="">
                    ...
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod">TPTA Listing</span></li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div class="table-responsive rounded-2">
                                    <table class="table customize-table mb-0 align-middle bg_tbody">
                                        <thead class="text-white fs-4 bg_blue">
                                            <tr>
                                                <th>ID</th>
                                                <th class="sorting" data-sorting_type="desc" data-column_name="pay_level_id"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#tpta-edit-form', function(e) {
                e.preventDefault();
