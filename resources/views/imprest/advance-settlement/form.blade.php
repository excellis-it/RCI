                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" class="form-control" name="adv_amount" id="adv_amount"
                                            value="{{ $advance_settlement->adv_amount }}" placeholder="" readonly>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12">
                                        <input type="number" class="form-control" name="bill_amount" id="bill_amount"
                                            value="{{ $advance_settlement->bill_amount }}" placeholder="">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="number" class="form-control" name="balance" id="balance"
                                            value="{{ $advance_settlement->balance }}" placeholder="" required
                                            readonly>
                                        <span class="text-danger"></span>
                                    </div>
                                </div>
