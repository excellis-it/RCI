...
@section('content')
    ...
    <div class="container-fluid">
        <div class="breadcome-list">
            <div class="d-flex">
                <div class="arrow_left"><a href="{{ route('cda-receipts.index') }}" class="text-white"><i
            ...
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            @if (isset($edit))
                                <form action="{{ route('cda-receipts.update', $cdaReceipt->id) }}" method="POST"
                                    id="cda-receipt-edit-form">
                                    @method('PUT')
                                    @csrf
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" class="form-control" name="voucher_no"
                                                                    id="voucher_no" value="{{ $cdaReceipt->voucher_no }}"
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" class="form-control"
                                                                    name="voucher_date" id="voucher_date"
                                                                    value="{{ $cdaReceipt->voucher_date }}" placeholder="">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mb-2">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" class="form-control" name="dv_date"
                                                                    id="dv_date" value="{{ $cdaReceipt->dv_date }}"
                                                                    placeholder="">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" class="form-control" name="amount"
                                                                id="amount" value="{{ $cdaReceipt->amount }}"
                                                                placeholder="">
                                                            <span class="text-danger"></span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-12">
                                                            @foreach ($cdaReceiptDetails as $key => $cdaReceiptDetail)
                                                                <div class="form-select" name="" id="">
                                                                    <select>
                                                                        <option value="{{ $cdaReceiptDetail->id }}"
                                                                            @if ($cdaReceiptDetail->id == $cdaReceipt->details) selected @endif>
                                                                            {{ $cdaReceiptDetail->name }}</option>
                                                                    </select>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="form-group col-md-4">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="text" class="form-control" name="vr_amount"
                                                ...
                                                <div class="form-group col-lg-8">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div>
                                                                <select name="details" class="form-select" name="" id="">
