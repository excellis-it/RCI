                                ...
                                @foreach ($settleBills as $index => $settleBill)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            height: 5px;
                                        ">
                                            {{ $settleBill->adv_date ? \Carbon\Carbon::parse($settleBill->adv_date)->format('d/m/Y') : '' }}
                                        </td>
                                        ...
                                        <td
                                            ...
                                            height: 5px;
                                        ">
                                            {{ formatIndianCurrency($settleBill->adv_amount, 2) }}
                                        </td>
                                        <td
                                            style="
                                            font-size: 16px;
                                        ...
                                        <td
                                            ...
                                            height: 5px;
                                        ">
                                            {{ $settleBill->var_date ? \Carbon\Carbon::parse($settleBill->var_date)->format('d/m/Y') :'' }}
                                        </td>
                                        <td
                                            style="
                                            font-size: 16px;
                                            ...
                                            height: 5px;
                                        ">
                                            {{ formatIndianCurrency($settleBill->bill_amount, 2) }}
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
