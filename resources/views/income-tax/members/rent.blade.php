                            ...
                            @if ($rents->isNotEmpty())
                                @foreach ($rents as $rent)
                                    <tr class="edit-route-loan" data-id="{{ $rent->id }}">
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-primary edit-rent"
                                                data-id="{{ $rent->id }}" data-month="{{ $rent->month }}"
                                                data-year="{{ $rent->year }}" data-rent="{{ $rent->rent }}">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            <button class="btn btn-sm btn-danger delete-rent"
                                                data-id="{{ $rent->id }}">
            ...
            function loadRentTable(financialYear) {
                ...
                $.ajax({
                    ...
                    <tr class="edit-route-loan" data-id="${rent.id}">
                        ...
                        <td>
                            <button class="btn btn-sm btn-primary edit-rent" data-id="${rent.id}"
                                    data-month="${rent.month}" data-year="${rent.year}"
                                    data-rent="${rent.rent}">
                                <i class="fa fa-edit"></i>
                            </button>
                            <button class="btn btn-sm btn-danger delete-rent" data-id="${rent.id}">
                                <i class="fa fa-trash"></i>
                            </button>
                        </td>
                    </tr>
