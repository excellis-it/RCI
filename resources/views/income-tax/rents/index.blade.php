...
@section('content')
            ...
            <div class="d-flex">
                ...
                <div class="">
                    ...
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod">Rents Edit</span></li>
                    </ul>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="tab-pane fade active show" id="loan-tab-pane" role="tabpanel"
                                            ...
                                            <div class="credit-frm">
                                                ...
                                                <div class="row mb-3" id="form-table">
                                                    @include('income-tax.rents.form-table')
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                $('#member_id').change(function() {
                    ...
                    $.ajax({
                        url: "{{ route('rents.member-details') }}",
                        type: 'POST',
                        data: {
                            _token: "{{ csrf_token() }}",
                            member_id: member_id
        ...
        <script>
            $(document).ready(function() {
                $(document).on('submit','#rents-form',function(e) {
                    e.preventDefault();
                    var form = $(this);
        ...
        <script>
            $(document).ready(function() {
                $(document).on('submit', '#rents-form-update', function(e) {
                    e.preventDefault();
                    var form = $(this);
                    var url = form.attr('action');
                    var type = form.attr('method');
