@if (isset($edit))
    <form action="{{ route('au-status.update', $au_status->id) }}" method="POST" id="designation-type-edit-form">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="status" id="status" value="{{ $au_status->status ?? '' }}"
                                    placeholder="">
