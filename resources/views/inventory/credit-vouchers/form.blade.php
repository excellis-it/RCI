                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="voucher_no" id="voucher_no"
                                    value="{{ $creditVoucher->voucher_no ?? '' }}" placeholder="" readonly>
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="add-more form-group col-md-4">
                        <a href="javascript:void(0);" class="add-pre_qualification" id="add-row"><i
        ...
        <div class="row new_html">
            <div class="col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <label>&nbsp;</label>
                        <button class="btn btn-danger trash form-control"><i class="fa fa-times"></i></button>
                    </div>
                </div>
            </div>
