                ...
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            ...
                            <form action="{{ route('inventory-members.store') }}" method="POST" id="member-create-form">
                                @csrf
    ...
    {{-- <script>
        ...
        $(document).ready(function() {
            $('#pm_level').change(function() {
                ...
                $.ajax({
                    url: "{{ route('inventory-members.grade-pay') }}",
                    type: 'POST',
                    data: {
                        pm_level: pm_level
                    },
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#group').change(function() {
                ...
                $.ajax({
                    url: "{{ route('inventory-members.get-cgegis-value') }}",
                    type: 'POST',
                    data: {
                        group: group
                    },
            ...
            $('#desig').change(function() {
                ...
                $.ajax({
                    url: "{{ route('inventory-members.get-category-value') }}",
                    type: 'POST',
                    data: {
                        desig: desig
                    },
