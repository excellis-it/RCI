          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
            <tbody>
              <tr>
                ...
                <td style="font-size: 14px; text-align: right; font-weight: bold;">DRDO.SM.30
                </td>
              </tr>
              <tr>
            ...
            <tbody>
              <tr>
                <td style="font-size: 16px;
                        ...
                        font-weight: 600;
                        color: #000;
                        text-align: left;">Financial Year:
                </td>
                <td style="font-size: 16px;
                        line-height: 18px;
                        font-weight: 600;
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top: 2rem">
            <tbody>
              <tr style="height: 80px;">
                ...
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Total No. <br> of Items
                </th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Name of <br> the Firm</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Invoice. <br> No. <br> & Date</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Amount <br> (Rs.)</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Cash <br> Purchase <br> Control <br> No. & Date</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Division</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
