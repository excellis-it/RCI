...
<body style="background: #fff">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tbody>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
            <tbody>
              <tr>
                ...
                <td style="font-size: 14px; text-align: right; font-weight: bold;">DRDO.SM.29
                </td>
              </tr>
              <tr>
      ...
      <tr>
        <td>
          <table width="100%" border="0" cellpadding="0" cellspacing="0" align="left" style="margin-top: 2rem">
            <tbody>
              <tr>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Period of <br> Loan</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  CRV No. & <br> Date
                </th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  EIV No. & <br> Date (Return)
                </th>
                ...
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Collected by Name <br> & Signature</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Loaner's RV No. & <br>
                  Date
                </th>
