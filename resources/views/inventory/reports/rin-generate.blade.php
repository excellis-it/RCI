...
<body style="background: #fff">
    @php
        ...
        $total_amount = 0;
    @endphp
    @foreach ($all_items_chunk as $all_items)
                                ...
                                <tbody>
                                    ...
                                    @if (count($all_items) <= 2)
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3"
                                                style="text-align:right; border-top: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000; border-bottom: 1px solid #000; padding: 5px; border-left: 0; font-weight: 600;font-size: 12px;">
                                                {{ Helper::formatDecimal($total_amount) ?? '' }}
                                                <br>({{ $words ?? '' }})
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="7"
                                            ...
                                            satisfactorily **.
                                            <br>
                                            <span style="padding-right: 5;">2.</span> Certified that the above stores
                                            have
                                            been
    ...
    @if ($all_items_chunk->last()->count() > 2 && $all_items_chunk->last()->count() <= 5)
        <div class="">
            <center>
                <img src="{{ public_path('storage/' . $logo->logo) }}" style="max-width: 50px;">
            </center>
