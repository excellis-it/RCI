        ...
        <body style="background: #fff">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
                <tbody>
                    ...
                    <tr>
                        ...
                        text-align: left;">
                                            ...
                                            Date:
                                            {{ $certificateIssueVoucher->voucher_date ? date('d-m-Y', strtotime($certificateIssueVoucher->voucher_date)) : '' }}
                                        </td>
                                        <td valign="top"
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($certificateIssueVoucher->details as $certificateIssuevoucherDetail)
                                        <tr>
                                            ...
                                            <td valign="top"
                                                ...
                                                {{ formatIndianCurrency($certificateIssuevoucherDetail->total_price, 2) ?? '' }}
                                            </td>
                                            <td valign="top"
                                                style="border: 1px solid black; padding: 10px 5px 10px 5px; font-size: 10px;">
                    ...
                    <tr>
                        ...
                        font-weight: 400;
                        color: #000;
                        text-align: left; padding-left: 10px; padding-bottom: 80px;">
                                            This is certified that the items mentioned above have
                                            been issued to authorized employees as per the enclosed list (if applicable
                    ...
                    <tr>
                        ...
                        color: #000;
                        text-align: left; padding-left: 10px;">
                                            Signature & Name of Inventory/ICC Holder
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                text-align: left; padding-left: 10px; border: 1px solid #000; height: 80px;">
                                            ...
                                            <br><br><br><br>
                                            <span style="text-align: right; display: block; font-size: 12px;">O/IC
                                                Ledger Section</span>
                                        </td>
                                    </tr>
                                </tbody>
