    ...
    <tbody>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
            <tbody>
              <tr>
                ...
                <td style="font-size: 14px; text-align: right; font-weight: bold;">DRDO.SM.25 <br>
                </td>
              </tr>
              <tr>
          ...
          <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top: 2rem">
            <tbody>
              <tr style="height: 120px;">
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">SI.
                  <br> No
                </th>
                ...
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Authority/ <br> Supply order <br> No & Date
                </th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Nomenclature
                </th>
                ...
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  RR/LR/ <br> AWB/APP <br> / RPP No. & <br> Date</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Name of <br> Consignee</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Issue <br> Voucher <br> No & <br> Date</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  MC Note <br> No & <br> Date</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  No. of <br> Packages</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Booked <br> Weight</th>
      ...
      <tr>
        <td style="    padding-left: 60px;">
          <table width="77%" border="0" cellpadding="0" cellspacing="0" align="left" style="margin-top: 2rem">
            <tbody>
              <tr style="height: 120px;">
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Freight <br> Paid/To <br> Pay</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Material Gate <br> Pass <br> No. & Date
                </th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">Name
                  of the <br> Transporter
                </th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Remarks</th>
                <th valign="top" style="border: 1px solid #000; padding: 5px; font-size: 14px; text-align: center;">
                  Signature of Store <br> Officer
                </th>
