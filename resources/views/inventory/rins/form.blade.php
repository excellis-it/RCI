                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="unit_cost" id="unit_cost"  value="{{ $rin->unit_cost }}"
                                    placeholder="" >
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="total_cost" id="total_cost"  value="{{ $rin->total_cost }}"
                                    placeholder="" >
                                <span class="text-danger"></span>
                            </div>
                        </div>
