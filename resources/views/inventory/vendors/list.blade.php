            ...
            <div class="d-flex">
                ...
                <div class="">
                    ...
                    <ul class="breadcome-menu mb-0">
                        ...
                        <li><span class="bread-blod">Vendor Listing</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            @include('inventory.vendors.form')
                        </div>
                                ...
                                <div class="table-responsive rounded-2">
                                    <table class="table customize-table mb-0 align-middle bg_tbody">
                                        <thead class="text-white fs-4 bg_blue">
                                            <tr>
                                                ...
                                                <th class="sorting" data-sorting_type="desc" data-column_name="name"
                                                    style="cursor: pointer"> Vendor Name <span id="name_icon"></span> </th>
                                                {{-- <th>Code</th> --}}
                                        ...
                                        <tbody class="tbody_height_scroll">
                                            @include('inventory.vendors.table')
                                        </tbody>
                                    </table>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#vendor-create-form').submit(function(e) {
                e.preventDefault();
