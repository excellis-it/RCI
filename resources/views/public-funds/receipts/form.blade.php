                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 mb-2">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="dv_no" id="dv_no" required>
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-md-4 mb-2 cheque-member-name">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-12">
                                                <input type="text" class="form-control member_name" required
                                                    readonly>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <label>Amount</label>
                                        <input type="number" class="form-control" name="member_amount[]" required>
                                            ...
                                            @foreach ($paymentCategories as $key => $paymentCategory)
                                                <div class="form-check form-check-inline ml-2">
                                                    <input class="form-check-input" type="radio" name="category"
                                                        id="inlineRadio{{ $key }}"
                                                        value="{{ $paymentCategory->id }}" required>
