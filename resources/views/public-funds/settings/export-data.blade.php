    ...
    <div class="container-fluid">
        <div class="breadcome-list">
            <div class="d-flex">
                ...
                <div class="">
                    <h3> Import Export Public Fund Data</h3>
                ...
                <div class="col-5">
                    ...
                    <form action="{{ route('csv.export') }}" method="GET" class="mt-5">
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="data_type" id="data_type" class="form-control" value="public-fund">
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function resolveConflict(replace) {
                ...
                formData.append('data_type', 'public-fund');
