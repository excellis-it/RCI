...
Route::get('/expired-run', function () {
    Artisan::call('migrate:session "2025-04-11" "20ExcellisRcKey25"');
});
...
Route::middleware('permssions')->group(function () {
    ...
    Route::prefix('income-tax')->group(function () {
        ...
        Route::post('/saving-pay-details', [IncomeTaxMemberController::class, 'payDetailsStore'])->name('income-tax.members-income-tax.saving.pay-details');
