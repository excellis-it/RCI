        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            <form action="<?php echo e(route('reports.payroll-generate')); ?>" method="POST" >
                                <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="form-group col-md-3 mb-2">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <?php if($errors->has('category')): ?>
                                                                    <div class="error" style="color:red;">
                                                                        <?php echo e($errors->first('category')); ?></div>
                                                                <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\RCI\resources\views/frontend/reports/payroll.blade.php ENDPATH**/ ?>