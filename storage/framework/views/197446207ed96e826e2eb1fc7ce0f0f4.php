<form action="<?php echo e(route('members.credit.update')); ?>" id="member-credit-form" method="post">
    <?php echo csrf_field(); ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="pay" id="basic-pay"
                            value="<?php echo e($member->basic  ?? (old('basic') ?? '')); ?>" placeholder="" readonly>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="da"
                            value="<?php echo e($member_credit->da ?? (old('da') ?? '')); ?>" placeholder="" id="da_percentage" readonly>
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="tpt" id="tpt"
                            value="<?php echo e($member_credit->tpt ?? (old('tpt') ?? '')); ?>" placeholder="" readonly>
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="cr_rent" id="cr_rent"
                            value="<?php echo e($member_credit->cr_rent ?? (old('cr_rent') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="g_pay" id="g_pay"
                            value="<?php echo e($member_credit->g_pay  ?? $member->g_pay ?? ''); ?>" placeholder="" readonly>
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="hra" id="hra"
                            value="<?php echo e($member_credit->hra ?? (old('hra') ?? '')); ?>" placeholder="" readonly>
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="da_on_tpt" id="da_on_tpt"
                            value="<?php echo e($member_credit->da_on_tpt ?? (old('da_on_tpt') ?? '')); ?>" placeholder="" readonly>
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="cr_elec" id="cr_elec"
                            value="<?php echo e($member_credit->cr_elec ?? (old('cr_elec') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="fpa" id="fpa"
                            value="<?php echo e($member_credit->fpa ?? (old('fpa') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="s_pay" id="s_pay"
                            value="<?php echo e($member_credit->s_pay ?? (old('s_pay') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="hindi" id="hindi"
                            value="<?php echo e($member_credit->hindi ?? (old('hindi') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="cr_water" id="cr_water"
                            value="<?php echo e($member_credit->cr_water ?? (old('cr_water') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="add_inc2" id="add_inc2"
                            value="<?php echo e($member_credit->add_inc2 ?? (old('add_inc2') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="npa" id="npa"
                            value="<?php echo e($member_credit->npa ?? (old('npa') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="deptn_alw" id="deptn_alw"
                            value="<?php echo e($member_credit->deptn_alw ?? (old('deptn_alw') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="misc_1" id="misc_1"
                            value="<?php echo e($member_credit->misc1 ?? (old('misc_1') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="var_incr" id="var_incr"
                            value="<?php echo e($member_credit->var_incr ?? (old('var_incr') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="wash_alw" id="wash_alw"
                            value="<?php echo e($member_credit->wash_alw ?? (old('wash_alw') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="dis_alw" id="dis_alw"
                            value="<?php echo e($member_credit->dis_alw ?? (old('dis_alw') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="misc_2" id="misc_2"
                            value="<?php echo e($member_credit->misc2 ?? (old('misc_2') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="spl_incentive" id="spl_incentive"
                                    value="<?php echo e($member_credit->spl_incentive ?? (old('spl_incentive') ?? '')); ?>" placeholder="">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="incentive" id="incentive"
                                    value="<?php echo e($member_credit->incentive ?? (old('incentive') ?? '')); ?>"
                                    placeholder="">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="risk_alw" id="risk_alw"
                                    value="<?php echo e($member_credit->risk_alw ?? (old('risk_alw') ?? '')); ?>" placeholder="">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="tot_credits" id="tot_credits"
                                    value="<?php echo e($member_credit->tot_credits ?? (old('tot_credits') ?? '')); ?>"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="var_amount" id="var_amount"
                                    value="<?php echo e($member_credit->variable_amount ?? (old('var_amount') ?? '')); ?>" placeholder="">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="arrs_pay_allowance" id="arrs_pay_allowance"
                                    value="<?php echo e($member_credit->arrs_pay_allowance ?? (old('arrs_pay_allowance') ?? '')); ?>"
                                    placeholder="">
                                <span class="text-danger"></span>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" name="remarks" id="remarks"
                            value="<?php echo e($member_credit->remarks ?? (old('remarks') ?? '')); ?>" placeholder="">
                        <span class="text-danger"></span>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp52\htdocs\RCI\resources\views/frontend/members/credit-form.blade.php ENDPATH**/ ?>