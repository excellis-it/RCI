                        ...
                        <tbody>
                            <tr>
                                <td style="font-size: 10px; line-height: 14px; font-weight: 600; color: #000; text-align: center; padding: 0px 5px !important;
                                    ...
                                    बेतन पर्ची PAY SLIP FOR THE MONTH OF : <?php echo e($monthName); ?>-<?php echo e($year); ?>
                    ...
                    <table width="100%" border="0" cellpadding="3" cellspacing="0" align="center">
                        <tbody>
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: left;  text-transform: uppercase; padding: 0px 0px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_data->emp_id ?? ''); ?><br>
                                    <?php echo e($member_data->name ?? ''); ?> <br>
                                    <?php echo e($member_data->desigs->designation ?? ''); ?>(<?php echo e($member_data->payLevels->value ?? ''); ?>)<br>
                                    <?php echo e($member_core_info->pan_no ?? ''); ?><br>
                                </td>
                                <td>
                                    <img style="width: 50px; height: 50px; margin: 0 auto; padding: 0px 5px !important;" src="<?php echo e(public_path('frontend_assets/images/drdo-logo.png')); ?>" />
                                </td>
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: left;  text-transform: uppercase; padding: 0px 0px !important;
                                    margin: 0px 0px !important;">
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: left;  text-transform: uppercase; padding: 0px 0px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_core_info->gpf_acc_no ?? ''); ?><br>
                                    <?php echo e($member_core_info->banks->bank_name ?? ''); ?> <br>
                                    <?php echo e($member_core_info->bank_acc_no ?? ''); ?><br>
                                    <?php echo e($member_core_info->banks->ifsc ?? ''); ?>
                    ...
                    <table width="100%" border="1" cellpadding="3" cellspacing="0" align="center">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->pay ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->gpa_sub ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->society ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->da  ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->gpf_adv ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_recoveries_data->mess ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->hra ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->gpf_arr ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_recoveries_data->wel_sub ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->tpt ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->cgegis ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->ptax ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->da_on_tpt ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->cghs ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_recoveries_data->asso_fee ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                   <?php echo e($member_credit_data->s_pay ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->hba_adv ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->spl_incentive ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->hba_int ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->incentive ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->car_adv ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->dis_alw ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->car_int ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->variable_amt ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->sco_adv ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->arrs_pay_alw ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->sco_int ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->risk_alw ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->comp_adv ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->misc1 ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->comp_int ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->misc2 ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->fadv ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->ltc ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->medi ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->tada ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->leave_rec ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->pension_rec ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->i_tax ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->ecess ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->pli ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->misc1 ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->misc2 ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_quarter_charge ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000;  padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->cgeis_arr ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->penal_intr ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; height: 20px; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_credit_data->tot_credits  ?? 0); ?>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->tot_debits ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000;  height: 20px; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($netPayBill - $secondDeduction); ?>
                    ...
                    <table width="100%" border="1" cellpadding="3" cellspacing="0" align="center">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000;  padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->elec ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                    <?php echo e($member_debit_data->water ?? 0); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 10px; line-height: 14px; font-weight: 400; color: #000; text-align: center;  text-transform: uppercase; border: 1px solid #000; padding: 0px 5px !important;
                                    margin: 0px 0px !important;">
                                <?php echo e($member_debit_data->furn ?? 0); ?>
...
<?php /**PATH C:\xampp82\htdocs\RCI\resources\views/frontend/reports/payslip-generate.blade.php ENDPATH**/ ?>