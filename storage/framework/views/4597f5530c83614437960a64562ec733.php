    ...
    <div class="container-fluid">
        <div class="breadcome-list">
            <div class="d-flex">
                ...
                <div class="">
                    <h3>Requition of <?php if(isset($member)): ?> <?php echo e($member->name); ?> <?php endif; ?> /<?php if(isset($tadaAdv)): ?> <?php echo e($tadaAdv->bill_no); ?> <?php endif; ?></h3>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <?php if($dataPriority->count() > 0 ): ?>
                        <h4><a href="<?php echo e(URL::to('/member-info/tada-advance/report-priority/'.$tadaAdv->id)); ?>"><i class="ti ti-download"></i> Download Report</a></h4>
                        <?php endif; ?>
                        <div id="form">
                            <?php echo $__env->make('frontend.member-info.tada-advance.form-priority', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                                ...
                                <div class="table-responsive rounded-2">
                                    <table class="table customize-table mb-0 align-middle bg_tbody">
                                        ...
                                        <tbody class="tbody_height_scroll">
                                            <?php echo $__env->make('frontend.member-info.tada-advance.table-priority', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\RCI\resources\views/frontend/member-info/tada-advance/list-priority.blade.php ENDPATH**/ ?>