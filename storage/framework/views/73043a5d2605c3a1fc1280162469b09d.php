<form  action="<?php echo e(route('tada-journey.add')); ?>" method="POST" id="tada-create-form">
        <?php echo csrf_field(); ?>
        <div class="row">
            <div class="col-md-8">
                <div class="row">
...
<?php /**PATH C:\xampp82\htdocs\RCI\resources\views/frontend/member-info/tada-advance/form-journey.blade.php ENDPATH**/ ?>