                        ...
                        <tbody>
                            <tr valign="top">
                                ...
                                ">
                                    ...
                                    Bank IFSC Code: <?php if(isset($memberInfo)): ?> <?php echo e($memberInfo->ifsc); ?> <?php endif; ?><br>
                                    Account Number: <?php if(isset($memberInfo)): ?> <?php echo e($memberInfo->bank_acc_no); ?> <?php endif; ?>
                                </th>
                                <th style=" font-size: 16px;
                                line-height: 18px;
                                font-weight: 600;
...
<?php /**PATH C:\xampp52\htdocs\RCI\resources\views/frontend/member-info/tada-advance/report-priority.blade.php ENDPATH**/ ?>