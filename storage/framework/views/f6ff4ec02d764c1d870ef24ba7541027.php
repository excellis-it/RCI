        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card w-100">
                    <div class="card-body">
                        <div id="form">
                            <?php echo $__env->make('frontend.member-info.gpf.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                                ...
                                <div class="table-responsive rounded-2">
                                    <table class="table customize-table mb-0 align-middle bg_tbody">
                                        ...
                                        <tbody class="tbody_height_scroll">
                                            <?php echo $__env->make('frontend.member-info.gpf.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $(document).on('keyup', '#monthly_subscription', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('member-info.gpf.check-amount')); ?>",
                type: 'POST',
                data: {
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\RCI\resources\views/frontend/member-info/gpf/list.blade.php ENDPATH**/ ?>