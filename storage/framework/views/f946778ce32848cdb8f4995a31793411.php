    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 text-end mb-3">
                <a class="print_btn" href="<?php echo e(route('members.create')); ?>">Add member</a>
            </div>
            <div class="col-lg-12">
                                ...
                                <div class="table-responsive rounded-2">
                                    <table class="table customize-table mb-0 align-middle bg_tbody">
                                        ...
                                        <tbody class="tbody_height_scroll">
                                            <?php echo $__env->make('frontend.members.table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </tbody>
                                    </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "<?php echo e(route('members.fetch-data')); ?>",
                    data: {
                        page: page,
                        sortby: sort_by,
                        sorttype: sort_type,
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp52\htdocs\RCI\resources\views/frontend/members/list.blade.php ENDPATH**/ ?>